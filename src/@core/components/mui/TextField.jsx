...
const TextFieldStyled = styled(TextField)(({ theme }) => ({
  ...
  '& .MuiInputBase-root': {
    ...
    '&.MuiInputBase-sizeSmall': { borderRadius: 'var(--mui-shape-borderRadius)' },
    ...
    '&.Mui-disabled': { backgroundColor: 'var(--mui-palette-action-hover) !important' }
  },
  '& .MuiFormHelperText-root': {
    lineHeight: 1.154,
    margin: theme.spacing(1, 0, 0),
...
const CustomTextField = forwardRef((props, ref) => {
  const {
    size = 'small',
    slotProps,
    // 🧹 Remove all internal props that React doesn't like
    sectionListRef,
    areAllSectionsEmpty,
    focusedSection,
    activeView,
