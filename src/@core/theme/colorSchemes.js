...
dark: {
  palette: {
    ...
    text: {
      ...
      disabled: '#999999',  // Light grey for disabled text
      primaryChannel: '0 0 0',
      secondaryChannel: '85 85 85'
    },
    background: {
      default: '#FFFFFF', // White background for page
    ...
    Alert: {
      ...
      infoColor: '#00BAD1',
      successColor: '#28C76F',
      errorStandardBg: 'rgba(255,76,81,0.08)',
      warningStandardBg: 'rgba(255,159,67,0.08)',
      infoStandardBg: 'rgba(0,186,209,0.08)',
      successStandardBg: 'rgba(40,199,111,0.08)',
      errorFilledColor: '#FFFFFF',
      warningFilledColor: '#FFFFFF',
      infoFilledColor: '#FFFFFF',
      successFilledColor: '#FFFFFF',
      errorFilledBg: '#FF4C51',
      warningFilledBg: '#FF9F43',
      infoFilledBg: '#00BAD1',
      successFilledBg: '#28C76F'
    },
    customColors: {
      bodyBg: '#FFFFFF',
      chatBg: '#F3F2F5',
