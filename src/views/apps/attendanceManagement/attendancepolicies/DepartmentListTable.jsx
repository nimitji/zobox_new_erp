...
import {editAttendancePolicy,fetchAttendancePolicy} from "../../../../app/server/actions"
...
// }
  ...
  const refreshDepartments = async () => {
    const res = await fetchAttendancePolicy()
    setData(res)
    setFilteredData(res)
  }
...
const handleUpdateDepartment = async updatedData => {
  try {
    console.log('Updated branch:', updatedData)
    //editDepartment
    const response = await editAttendancePolicy(updatedData)
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor('lateArrivalGrace', {
        header: 'Late Grace (mins)',
        enableSorting: true, 
        cell: ({ row }) => (
          <Typography className='capitalize' color='text.primary'>
            {row.original.lateArrivalGrace}
          </Typography>
        )
      }),
        columnHelper.accessor('earlyDeparture', {
        header: 'Early Grace (mins)',
        enableSorting: true, 
        cell: ({ row }) => (
          <Typography className='capitalize' color='text.primary'>
            {row.original.earlyDeparture}
          </Typography>
        )
      }),
