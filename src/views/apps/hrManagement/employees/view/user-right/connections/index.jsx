...
const ConnectionsTab = () => {
  ...
  useEffect(() => {
    ...
    if (stored) {
      ...
      setFamilyData(user?.userFamilyDetails || null)
    }
  }, [])
  ...
  const { fatherName, motherName, spouseName } = familyData
      ...
      <Grid size={{ xs: 12 }}>
        <Card>
          <CardHeader
            ...
            subheader='Information about employee’s immediate family members'
          />
          <Divider />
          <CardContent>
