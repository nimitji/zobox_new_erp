...
// import { fetchCountEmployeeSalary } from '../../../../app/server/actions'
...
//     const getData = async () => {
//       try {
//         const response = await fetchCountAttendanceRecord()
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        ...
        // ⭐ API call with token
        const response = await fetchCountEmployeeSalary(token)
