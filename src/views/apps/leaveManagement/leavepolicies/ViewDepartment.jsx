  ...
  return (
    ...
    >
      ...
      <div className='flex items-center justify-between pb-3'>
        <Typography variant='h5'>View Leave Policy</Typography>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12}>
            <CustomTextField
              label='Policy Name'
              fullWidth
              value={departmentData.policyName || ''}
         ...
         <Grid item xs={12}>
            <CustomTextField
              label='Accural Type'
              fullWidth
              value={departmentData.accuralType || ''}
              InputProps={{ readOnly: true }}
            />
          </Grid>
           <Grid item xs={12}>
            <CustomTextField
              label='Accural Rate(Days)'
              fullWidth
              value={departmentData.accuralRates || ''}
              InputProps={{ readOnly: true }}
            />
          </Grid>
              <Grid item xs={12}>
            <CustomTextField
              ...
              fullWidth
              value={departmentData.carryForwardLimit || ''}
              InputProps={{ readOnly: true }}
            />
          </Grid>
                 <Grid item xs={12}>
